<div class="col-12">
    <div class="caixa">
        <div class="p-2 py-1 bg-title text-light text-uppercase h4 mb-0 text-branco d-flex justify-content-space-between">
			<span class="d-flex center-middle"><i class="far fa-list-alt mr-1"></i> Lista de unidade </span>
			<div>
				<a href="<?php echo URL_BASE . "unidade/create" ?>" class="btn btn-verde mx-1 d-inline-block">
