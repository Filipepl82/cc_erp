                ...
                <div class="rows">
                        ...
                        <div class="col-3 mb-3">
                            ...
                            <select class="form-campo" name="eh_insumo">
                                <option value="">SELECIONE</option>
                                <option value="S" <?php echo ($produto->eh_insumo == "S") ? "selected" : "" ?>>Sim</option>  
                                <option value="N" <?php echo ($produto->eh_insumo == "N") ? "selected" : "" ?>>Não</option>  
                            </select>
                        </div>
                        <div class="col-3 mb-3">
                        ...
                        <div class="col-3 mb-3">
                            ...
                            <select class="form-campo" name="eh_maisvendido">
                                <option value="">SELECIONE</option>
                                <option value="S" <?php echo ($produto->eh_maisvendido == "S") ? "selected" : "" ?>>Sim</option>  
                                <option value="N" <?php echo ($produto->eh_maisvendido == "N") ? "selected" : "" ?>>Não</option>  
                            </select>
                        </div>
                        <div class="col-3 mb-3">
                        ...
                        <div class="col-3 mb-3">
                            ...
                            <input type="text" name="custo_medio" value="<?php echo ($produto->custo_medio) ? $produto->custo_medio : null ?>" placeholder="Digite aqui..." class="form-campo">
                        </div>
                        <div class="col-3 mb-3">
                        ...
                        <div class="col-4 mb-3">
                            ...
                            <input type="text" name="estoque_maximo" value="<?php echo ($produto->estoque_maximo) ? $produto->estoque_maximo : null ?>" placeholder="Digite aqui..." class="form-campo">
                        </div>
                        <div class="col-4 mb-3">
