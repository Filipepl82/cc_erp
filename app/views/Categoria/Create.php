<div class="p-2 bg-title text-light text-uppercase h5 mb-0 text-branco d-flex justify-content-space-between">
	...
	<a href="lst_categoria.html" class="btn btn-verde btn-pequeno">
    ...
    <div class="col-6 d-block m-auto rows px-5 py-">
		<div class="border radius-4 mt-5 px-4">
			<div class="col-12 mb-3 mt-5">
				...
				<input type="text" name="categoria" value="<?php echo isset($categoria->categoria) ? $categoria->categoria : null ?>" class="form-campo" placeholder="Digite o nome da categoria" />
			</div>                                   
